...
tsne_plot(recipient_coords) %>%
  add_point(recipient_coords %>% filter(cw == "government"), 4, 4, font_size = 10) %>%
  add_point(recipient_coords %>% filter(cw == "mother"), -3, -3, font_size = 10) %>% 
  add_point(recipient_coords %>% filter(cw == "him"), -2, -2, font_size = 10) %>%
  add_point(recipient_coords %>% filter(cw == "guy"), 2, 3, font_size = 10)
```
...
tsne_plot(theme_coords) %>%
  add_point(theme_coords %>% filter(cw == "it"), -4, -7, vjust = 1, font_size = 15)
```
